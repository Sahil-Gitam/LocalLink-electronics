# AI Coding Agent Instructions for Localink E-commerce

## Project Overview

**Localink** is a production-ready, full-stack MERN (MongoDB, Express, React, Node.js) e-commerce application featuring:
...
- **Local Storage**: Cart persists across sessions (`localinkCart` key)
...
3. Test build locally: `docker build -t localink-app .`
...
**Version**: 1.1.0
**Maintained by**: Sahil Purkayasta
