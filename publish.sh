...
@sahil-gitam:registry=https://npm.pkg.github.com
EOF

echo "🚀 Publishing @sahil-gitam/ecommerce-fullstack-website-frontend to GitHub Packages..."
npm publish --access public

# 3) Friendly confirmation
NAME=$(node -p "require('./package.json').name")
VERSION=$(node -p "require('./package.json').version")
echo "✅ Published ${NAME}@${VERSION} to https://npm.pkg.github.com/Sahil-Gitam"
